...
public class Main {
    public static void main(String[] args) {
        ...
        try{
            ...
            csvData.add(new String[]{"Invoice Document", "Invoice Number", "Invoice Date",
                ...
                for (PageIterator it = extractor.extract(); it.hasNext(); ) {
                    ...
                    if (!tables.isEmpty()) {
                        ...
                        if (table.getRowCount() > 0 && table.getColCount() > 1) {
                            ...
                            extractor.close();
                            return new String[]{"Supplier", supplier, "Supplier No.", supplerNo, date };
                        }
                    }
                }
                extractor.close();
